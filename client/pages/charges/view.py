...
monthly_charges_plot = dbc.Card(
    [
        dbc.CardHeader("Monthly Charges"),
        dbc.CardBody(
            [
                dcc.Graph(id="monthly-charges-graph"),
            ]
        ),
    ],
...
@app.callback(Output('charges-tabs-content', 'children'),
              [Input('charges-tabs', 'value')])
...
charges_layout =html.Div(children=[
    ...
    html.Div([
                ...
                html.Br(),
                 ...
                 # tabs
                dcc.Tabs(id="charges-tabs", value='cpt_tab',children=[
                ...
                html.Div(id='charges-tabs-content')
...
@app.callback(
    Output("monthly-charges-graph","figure"),
    [Input("financial_class","value")],

    )

def update_charge_plot(fin_class,):
